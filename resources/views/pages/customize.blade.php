...
<div id="emptyState" class="mt-10 rounded-xl border border-dashed border-gray-300 bg-white p-10 text-center text-gray-600">
  ...
  <p class="mt-2">Click “Create Custom Request” to add your first customized product.</p>
</div>
@else
...
<form method="POST" action="/customize/{{ $design->id}}">
    @csrf
    @method('DELETE')
    <button 
        type="submit"
        class="w-full flex justify-end gap-2 rounded-lg px-4 py-3 font-extrabold text-red-700 transition"
    >
